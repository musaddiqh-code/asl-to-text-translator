...
def draw_ui(frame, sign, conf, word, sentence, auto_prog, hand_present):
    ...
    cv2.putText(frame, "ASL -> Text Translator", (10,30), FONT, 0.9, (255,255,255), 1)
    ...
    if sign and conf >= CONFIDENCE_THRESH:
        cv2.putText(frame, sign.upper(), (cx+50, cy+100), FONT, 3.5, (50,220,80), 5)
        cv2.putText(frame, f"conf: {conf*100:.0f}%", (cx+8, cy+118), PLAIN, 1.1, (150,150,150), 1)
        draw_bar(frame, cx+8, cy+125, 175, 13, conf, (50,220,80))
        if auto_prog > 0:
            cv2.putText(frame, "Hold to auto-add...", (cx+8, cy+150), PLAIN, 0.9, (30,160,255), 1)
            draw_bar(frame, cx+8, cy+155, 175, 8, auto_prog, (30,160,255))
    elif not hand_present:
        cv2.putText(frame, "No hand", (cx+25, cy+85), FONT, 0.8, (130,130,130), 1)
    else:
        cv2.putText(frame, "Low conf", (cx+18, cy+85), FONT, 0.8, (60,60,200), 1)
...
def main():
    ...
    while True:
        ...
        draw_ui(frame, cur_sign, cur_conf, word, sentence, auto_progress, hand_present)
